...
<form role="form" enctype="multipart/form-data" action="/page/{{$page->abbr}}/post" method="post">
    <!--Sharing Text-->
    <div class="form-group{{ $errors->has('post') ? ' has-error' : '' }}">
        <textarea placeholder="Sayfa üzerinde paylaşım yap..." name="post" class="form-control" rows="2"></textarea>
        @if($errors->has('post'))

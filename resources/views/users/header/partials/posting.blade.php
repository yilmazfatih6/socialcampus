...
<form role="form" action="/status" enctype="multipart/form-data" method="post">

    <!--Textarea-->
    <div class="form-group{{$errors->has('status') ? ' has-error' : ''}}">
        <textarea placeholder="Aklından neler geçiyor {{ Auth::user()->getFirstNameOrUsername() }}?" name="status" class="form-control" rows="2"></textarea>
